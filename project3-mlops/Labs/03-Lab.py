...
#  TODO
import cloudpickle, numpy, pandas, sklearn, pip
dbutils.fs.rm(path + "conda.yaml", True)
...
#  TODO
dbutils.fs.rm('dbfs:/user/whenning@ur.rochester.edu/mlflow/03_lab_psp/03-lab/train.py', True)
